  ...
  <div class="text-center page-header">
    ...
    <div class="accordion-item">
        ...
        <div class="accordion-body">
                ...
                <div class = "text-center"><h4>Enter Questionnaire Details to Modify</h4></div>
                    <hr>
                ...
                <!-- Submit button -->
                <button type="submit" name="ModifyQuestionnaire" class="btn btn-primary btn-block">Submit</button>
                <br>
                </form>
    ...
    <div class="accordion-item">
        ...
        <div class="accordion-body">
                ...
                <form method="post" class="w-25 p-3" style="margin-left: 37.5%;"> 
                    <div class = "text-center"><h4>Enter Question Details</h4></div>
                    <hr>
                ...
                <!-- Submit button -->
                <button type="submit" name="CreateQuestion" class="btn btn-primary btn-block">Submit</button>
                <br>
                </form>
    ...
    <div class="accordion-item">
        ...
        <div class="accordion-body">
                ...
                <div class = "text-center"><h4>Enter Question Number ID</h4></div>
                    <hr>
